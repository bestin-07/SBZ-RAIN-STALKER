const translations = {
  de: {
    ...
    s_rain_back:      ['kurze pause — regen kommt in {low}–{high} min zurück', 'kurzes trockenfenster, regen zurück in {low}–{high} min', 'pause gerade, nächster schauer in {low}–{high} min'],
  ...
  en: {
    ...
    s_rain_back:      ['short break — rain returns in {low}–{high} min', 'brief dry gap, rain back in {low}–{high} min', 'a lull now, next shower in {low}–{high} min'],
