...
export const translations = {
  de: {
    ...
    guide_ribbon_3: 'Kräftige Balken kommen vom Radar — die ersten rund 2½ Stunden, also was tatsächlich fällt. Blasse, gedeckte Balken kommen vom Wettermodell und sind weniger sicher.',
  ...
  en: {
    ...
    guide_ribbon_3: 'bold bars come from radar — the first 2½ hours or so, what is actually falling. pale, muted bars come from the weather model, so they are less certain.',
