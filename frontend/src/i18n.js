...
export const translations = {
  de: {
    ...
    guide_days_2: 'Der Verlauf sind zwölf kleine Balken à zwei Stunden, in denselben Farben wie das Regenband. Ein nasser Nachmittag sieht oben und unten gleich aus.',
    ...
    guide_ribbon_3: 'Kräftige, farbige Balken kommen vom Radar — die ersten rund 2½ Stunden, also was tatsächlich fällt. Graue Balken kommen vom Wettermodell und sind weniger sicher.',
    ...
    guide_ribbon_7: 'Ein gestrichelter Rand heißt: die zwei Wettermodelle, die wir vergleichen, sind sich hier nicht einig.',
  ...
  en: {
    ...
    guide_days_2: 'the shape is twelve little bars of two hours each, in the same colours as the rain ribbon. a wet afternoon looks wet in both places.',
    ...
    guide_ribbon_3: 'bold, coloured bars come from radar — the first 2½ hours or so, what is actually falling. grey bars come from the weather model, so they are less certain.',
    ...
    guide_ribbon_7: 'a dashed edge means the two weather models we compare do not agree there.',
