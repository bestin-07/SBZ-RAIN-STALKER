const translations = {
  de: {
    ...
    STUCK:        'BLEIB DRIN',
    s_light:      ['nur ein bissl regen — kapuze auf und los', 'leichter niesel, halb so wild — geh ruhig raus', 'kaum der rede wert, passt schon — ab nach draußen'],
  ...
  en: {
    ...
    STUCK:        'STUCK INSIDE',
    s_light:      ['just a light drizzle — hood up and go', 'barely raining, honestly fine — head out', "nothing serious out there — you're good to go"],
