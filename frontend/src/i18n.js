const translations = {
  ...
  en: {
    ...
    weather_thunder:   ['thunderstorm over salzburg — stay safe', 'lightning outside, {temp}°, better stay in', 'thunder and lightning, not the night to be out', 'thunder outside — great soundtrack, bad idea to go out'],
