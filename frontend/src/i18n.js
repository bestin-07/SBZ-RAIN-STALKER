const translations = {
  de: {
    ...
    info_p4: 'Als dritte Quelle werden die drei nächstgelegenen GeoSphere Austria TAWES-Messstationen abgefragt — alle 10 Minuten aktualisierte Echtzeitmessungen, kein Modell.',
    info_p5: 'Zusätzlich wird der DWD-Radarwert direkt an deinem GPS-Punkt abgefragt (RADOLAN, alle 5 Minuten). Das ist die schnellste verfügbare Quelle. Damit wird Regen erkannt bevor das Vorhersagemodell ihn sieht.',
  ...
  en: {
    ...
    info_p4: 'As a third source, the three nearest GeoSphere Austria TAWES weather stations are queried for actual 10-minute precipitation measurements — real observations, not a model.',
    info_p5: 'Fourth, the DWD RADOLAN radar value is sampled at your exact GPS point every refresh (5-minute updates). This is the fastest available signal and catches rain before the forecast model does.',
