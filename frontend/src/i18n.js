const translations = {
  de: {
    ...
    info_p3: 'Radar stammt vom Deutschen Wetterdienst (DWD) über das OPERA Netzwerk. Animierte Radarframes von RainViewer.',
    info_p4: 'Als dritte Quelle werden Echtzeit-Messdaten der GeoSphere Austria TAWES-Station am Flughafen Salzburg (ca. 3 km vom Stadtzentrum) abgefragt — aktualisiert alle 10 Minuten. So wird Regen erkannt, der das Vorhersagemodell noch nicht erfasst hat.',
    info_p5: 'Genauigkeit wird automatisch verfolgt, Vorhersagen werden gespeichert und später mit den tatsächlichen Werten verglichen.',
    data_sources: 'Datenquellen',
    src_forecast: 'Vorhersage',
    src_radar:    'Radar',
    src_station:  'Messstation',
  ...
  en: {
    ...
    info_p3: 'Radar comes from the German Weather Service (DWD) via the OPERA network. Animated frames from RainViewer.',
    info_p4: 'As a third source, real-time measurements from the GeoSphere Austria TAWES station at Salzburg Airport (~3 km from the city centre) are checked every refresh — updated every 10 minutes. This catches rain that the forecast model has not yet picked up.',
    info_p5: 'Accuracy is tracked automatically, predictions are stored and later checked against actual readings.',
