const translations = {
  de: {
    ...
    privacy_page_what:         'Was wir speichern',
    privacy_page_what_body:    'Nur dein Browser-Push-Token — nötig um dir Regenlücken zu melden. Kein Name, keine E-Mail, kein Standort.',
    privacy_page_notrack:      'Was wir nicht speichern',
    privacy_page_notrack_body: 'Kein GPS-Standort (geht direkt von deinem Browser an Open-Meteo). Keine Cookies, kein Analytics, kein Tracking.',
    privacy_page_browser:      'Im Browser gespeichert',
    privacy_page_browser_body: 'Nur Design- und Spracheinstellung (localStorage). Keine persönlichen Daten.',
    privacy_page_push:         'Push-Dienste',
    privacy_page_push_body:    'Dein Push-Token geht über den Dienst deines Browsers (Google FCM / Mozilla / Apple APNs). Wir schicken Nachrichten nur über diesen Kanal.',
    privacy_page_basis:        'Rechtsgrundlage',
    privacy_page_basis_body:   'Wetterabfrage: berechtigtes Interesse (Art. 6 Abs. 1 lit. f DSGVO). Push: Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) — jederzeit widerrufbar über die Glocke.',
    privacy_page_rights:       'Deine Rechte',
    privacy_page_rights_body:  'Abbestellen: Glocke antippen → sofort gelöscht. Auskunft / Löschung per E-Mail: bestindroid@gmail.com. Beschwerden: dsb.gv.at',
    privacy_page_who:          'Verantwortlich',
    privacy_page_who_body:     'Bestin Antu · Salzburg · bestindroid@gmail.com',
  ...
  en: {
    ...
    privacy_page_what:         'What we store',
    privacy_page_what_body:    'Only your browser push token — needed to send you rain alerts. No name, email, or location.',
    privacy_page_notrack:      'What we don\'t collect',
    privacy_page_notrack_body: 'No GPS location (goes directly from your browser to Open-Meteo). No cookies, no analytics, no tracking.',
    privacy_page_browser:      'Stored in your browser',
    privacy_page_browser_body: 'Only theme and language preference (localStorage). No personal data.',
    privacy_page_push:         'Push services',
    privacy_page_push_body:    'Your push token passes through your browser\'s push service (Google FCM / Mozilla / Apple APNs). We can only message you through that channel.',
    privacy_page_basis:        'Legal basis',
    privacy_page_basis_body:   'Weather lookup: legitimate interest (Art. 6(1)(f) GDPR). Push: consent (Art. 6(1)(a) GDPR) — withdraw anytime via the bell.',
    privacy_page_rights:       'Your rights',
    privacy_page_rights_body:  'Unsubscribe: tap the bell → deleted immediately. Access / erasure by email: bestindroid@gmail.com. Complaints: dsb.gv.at',
    privacy_page_who:          'Data controller',
    privacy_page_who_body:     'Bestin Antu · Salzburg · bestindroid@gmail.com',
